...
export default function HeroSection() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce hidden sm:block" aria-hidden="true" style={{ transform: 'translateX(-50%) translateZ(0)' }}>
        <div className="w-6 h-10 border-2 border-white/50 rounded-full flex justify-center">
          <div className="w-1 h-3 bg-white/50 rounded-full mt-2 animate-pulse" style={{ transform: 'translateZ(0)' }}></div>
        </div>
      </div>
    </section>
  );
